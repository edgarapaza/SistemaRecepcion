...
public class ReporteExpArchivado {
Connection conn=null;
public ReporteExpArchivado()
{
try
{
...
public void ejecutarReporte(String solicitud){
	...
	//JOptionPane.showMessageDialog(null,f.getAbsolutePath()); // Llamamos al método que devuelve la ruta absoluta
        ...
        //String archivo = System.getProperty("user.dir") + "/dist/report/reportExpArchivado.jasper";
        //String archivo = "C:/SistemaSolicitudes/src/sistemasolicitudes/reportExpArchivado.jasper";
