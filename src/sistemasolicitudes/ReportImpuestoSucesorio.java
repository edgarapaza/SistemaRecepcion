...
public class ReportImpuestoSucesorio {
    
    Connection conn=null;
    conexion obj = new conexion();
    
    public ReportImpuestoSucesorio() throws ClassNotFoundException
    {
        try
        {
    ...
    public void ejecutarReporte(String solicitud){
        ...
        try{                     
            ...
            String archivo = f.getAbsolutePath() + "\\report\\reportImpuestoSucesorio.jasper";

            //String archivo = "C:/Users/edgar/Documents/NetBeansProjects/SistemaSolicitudes/src/sistemasolicitudes/reportImpuestoSucesorio.jasper";
