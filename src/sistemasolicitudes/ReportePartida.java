...
public void ejecutarReporte(String solicitud){
	...
	//JOptionPane.showMessageDialog(null,f.getAbsolutePath()); // Llamamos al método que devuelve la ruta absoluta
        String archivo = f.getAbsolutePath() + "\\report\\reportPartidasNac.jasper";
        JOptionPane.showMessageDialog(null, archivo);
        
        //String archivo = System.getProperty("user.dir") + "/dist/report/reportPartidasNac.jasper";
        //String archivo = "C:/SistemaSolicitudes/src/sistemasolicitudes/reportPartidasNac.jasper";
        //String archivo = "/home/edgar/NetBeansProjects/SistemaSolicitudes/src/sistemasolicitudes/reportPartidasNac.jasper";
